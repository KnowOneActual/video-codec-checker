    ...
    def check(self, video_info: Dict[str, Any]) -> List[CompatibilityIssue]:
        ...
        if bitrate:
            ...
            if bitrate > 100_000_000:
                ...
                width, height = resolution
                # 1080p < 4.5 Mbps
                if width >= 1920 and height >= 1080 and bitrate < 4_500_000:
                    issues.append(
                        CompatibilityIssue(
                            level=CompatibilityLevel.WARNING,
                ...
                if width >= 3840 and height >= 2160:
                    issues.append(
                        CompatibilityIssue(
                            ...
                            reason=(
                                "Multiple 4K layers can stress even " "GPU-accelerated playback"
                            ),
                ...
                if bitrate < 15_000_000:  # Less than 15 Mbps
                    ...
                    issues.append(
                        CompatibilityIssue(
                            level=CompatibilityLevel.COMPATIBLE,
                            message=(
                                f"HD bitrate ({mbps}Mbps) is suitable within " "recommended range"
                            ),
                        )
                    )
